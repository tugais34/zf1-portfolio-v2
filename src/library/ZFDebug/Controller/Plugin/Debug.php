...
class ZFDebug_Controller_Plugin_Debug extends Zend_Controller_Plugin_Abstract
{
    ...
    /**
     * Returns html header for the Debug Bar Only CSS
     *
     * @return string
     */
    protected function _headerOutputCss() {
        return ('
    ...
    /**
     * Returns html header for the Debug Bar Only JS
     *
     * @return string
     */
    protected function _headerOutputJs() {
    ...
    protected function _output($html)
    {
        ...
        $response->setBody(preg_replace('/(<head.*>)/i', '$1' . $this->_headerOutputCss(), $response->getBody()));
        $response->setBody(str_ireplace('</body>', $this->_headerOutputJs() . '<div id="ZFDebug_debug">'.$html.'</div></body>', $response->getBody()));
    }
}